...
Average_Check_Segment varchar not null,
Frequency_Segment varchar not null,
Churn_Segment varchar not null
);
--
...
copy customer_segmentation
from E'/var/lib/postgresql/Customer_segmentation.tsv' delimiter E'\t' CSV HEADER;
--
INSERT INTO checks (
Transaction_ID,
SKU_ID,
