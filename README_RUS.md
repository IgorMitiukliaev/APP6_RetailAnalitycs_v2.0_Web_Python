...
- Тебе необходимо полностью переиспользовать базу данных из проекта SQL3, включив её в компонент Model (при этом используй ORM *ORM Django или SQLAlchemy* в режиме Model/Database First).
...
### Администратор 
- Имеет полные права на редактирование и просмотр любой информации, запуск и остановку процесса обработки.
...
Реализуй SPA-frontend на любом компонентом фреймворке (Vue/React/Angular).
